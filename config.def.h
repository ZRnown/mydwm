...
static const char *fonts[]          = { "FiraCode Nerd Font Mono:size=15","WenQuanYi Micro Hei:size=15:type=Regular:antialias=true:autohint=true","Symbols Nerd Font:pixelsize=15:type=2048-em:antialias=true:autohint=true"};
...
static const char *dmenucmd[] = { "rofi","-show","drun","-theme","lobster",NULL };
